...
public final class ScheduleBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView lvWeek;

  private ScheduleBinding(@NonNull ConstraintLayout rootView, @NonNull ListView lvWeek) {
  ...
  public static ScheduleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.lvWeek;
      ListView lvWeek = rootView.findViewById(id);
      if (lvWeek == null) {
        break missingId;
      }

      return new ScheduleBinding((ConstraintLayout) rootView, lvWeek);
    }
